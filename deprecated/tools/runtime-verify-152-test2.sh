...
say "== runtime verify: 1.5.2-universal-test.2 =="
say "target=$moddir"
...
grep -n '^version=1.5.2-universal-test.2$' "$moddir/module.prop"
grep -n '^versionCode=1016202$' "$moddir/module.prop"
say "PASS module_version_test2"
...
matrix_log="${TMPDIR:-/data/local/tmp}/pixel_thermal_matrix_152_test2_$$.log"
...
status_log="${TMPDIR:-/data/local/tmp}/pixel_thermal_status_152_test2_$$.log"
...
say "RESULT: PIXEL_THERMAL_152_TEST2_RUNTIME_VERIFY_DONE"
