...
- [2.0.0-alpha.3-dev.2](2.0.0-alpha.3-dev.2.md) — lean development prerelease with single-pass install choices, canonical validation state, local dynamic build admission, and exact Mustang runtime proof.
- [2.0.0-alpha.2](2.0.0-alpha.2.md) — public guarded Android 17 Pixel 10 prerelease.
