...
echo "health_log_model=read_only_guard_first_plus_optional_zram_100p_service" >> "$H"
...
# Give Magisk/KernelSU overlay mounts time to settle before health and optional ZRAM handling.
sleep 20
