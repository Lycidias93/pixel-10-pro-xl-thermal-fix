...
grep -Fq 'version=2.1.0-alpha.8' "$module_prop"
grep -Fq 'versionCode=1016258' "$module_prop"
...
grep -Fq '"version": "2.1.0-alpha.8"' "$update_meta"
grep -Fq '"versionCode": 1016258' "$update_meta"
grep -Fq '/v2.1.0-alpha.8/pixel-thermal-memory-control-2.1.0-alpha.8.zip' "$update_meta"
