...
grep -Fq 'version=2.1.0-alpha.7' "$module_prop"
grep -Fq 'versionCode=1016257' "$module_prop"
...
grep -Fq '"version": "2.1.0-alpha.7"' "$update_meta"
grep -Fq '"versionCode": 1016257' "$update_meta"
grep -Fq '/v2.1.0-alpha.7/pixel-thermal-memory-control-2.1.0-alpha.7.zip' "$update_meta"
