...
grep -Fq 'version=2.1.0-alpha.6' "$module_prop"
grep -Fq 'versionCode=1016256' "$module_prop"
...
grep -Fq '"version": "2.1.0-alpha.6"' "$update_meta"
grep -Fq '"versionCode": 1016256' "$update_meta"
grep -Fq '/v2.1.0-alpha.6/pixel-thermal-memory-control-2.1.0-alpha.6.zip' "$update_meta"
