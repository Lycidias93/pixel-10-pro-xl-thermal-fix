...
collect compat_check.txt sh -c 'if [ -x /data/adb/modules/pixel-10-pro-xl-thermal-fix/tools/bootguard/compat-check.sh ]; then /data/adb/modules/pixel-10-pro-xl-thermal-fix/tools/bootguard/compat-check.sh; else echo compat_check_missing; fi'
