...
record 'schema=pixel-thermal-dev8-prerelease-publication-v2'
...
record 'phase=artifact_metadata_verify'
...
record 'phase=artifact_download_and_package_verify'
rm -rf "$artifact_dir"
...
record 'phase=notes_and_channel_boundary'
