...
say "== runtime verify: 1.5.2-universal-test.3 =="
say "target=$moddir"
...
grep -n '^version=1.5.2-universal-test.3$' "$moddir/module.prop"
grep -n '^versionCode=1016203$' "$moddir/module.prop"
say "PASS module_version_test3"
...
matrix_log="${TMPDIR:-/data/local/tmp}/pixel_thermal_matrix_152_test3_$$.log"
...
status_log="${TMPDIR:-/data/local/tmp}/pixel_thermal_status_152_test3_$$.log"
...
say "RESULT: PIXEL_THERMAL_152_TEST3_RUNTIME_VERIFY_DONE"
